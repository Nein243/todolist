...
<?php endif; ?>
    ...
    <div class="shared-category_container">
        <div class="shared-category_grid">
            <?php if ($isTeamOwner): ?>
                <?php require_once 'add-team-category.php' ?>
            <?php endif; ?>
            <?php require_once 'team-category.php' ?>
        </div>
        <div class="shared-category_add-task">
            <?php require_once 'add-team-task.php'; ?>
        </div>
    </div>
