<?php require_once 'handler/function.php' ?>
<div class="user-block">
    ...
    <div class="user-hidden">
        <ul class="navigation-section">
            ...
            <li class="navigation-row"><a href="">Settings</a></li>
            <li class="navigation-row">
                <a href="invite-team-list.php">Invitations:
                    <span><?= countInvitesNumber($_SESSION['id']) ?></span>
                </a>
            </li>
